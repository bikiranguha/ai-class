...
#		os.system("pause")
		if currentList == [0,1,2,3,4,5,6,7,8]:
			getpath =[]
			while currentListStr != initialStateStr:  # Probably the parent dictionary is not working properly, debug using backward find in the while loop
				print currentListStr
				os.system("pause")
